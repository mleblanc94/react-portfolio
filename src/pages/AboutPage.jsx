...
export default function AboutPage() {
    return (
        ...
        <p className="black b f4 lh-copy">My name is Michael LeBlanc and I am a developer from the Boston Area. I am very
          ...
          <p className="black b f4 lh-copy">Some of my hobbies outside of coding include watching sports, going with friends, playing golf, and fitness. Outside of coding for work, I also love coding
